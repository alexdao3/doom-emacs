;;; private/alexdao/bindings.el -*- lexical-binding: t; -*-
...
(map! [remap evil-jump-to-tag] #'projectile-find-tag
      ...
      (:leader
        ...
        (:desc "javascript" :prefix "j"
          :desc "Switch btwn js/test"   :n  "t" #'wpc/toggle-between-js-test-and-module
          :desc "Insert Flow annot"     :n  "f" #'wpc/insert-flow-annotation)
          ;; :desc "Create snippet"        :n  "s" wpcarro/create-snippet)
